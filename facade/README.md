# facade
## Running:
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#snapshot/773f98d0-6ec6-447c-9b36-fc9192d07a43)
run 
cd facade
lein deps
lein watch
### Optionally, jack in from Calva

This is copied from a [re-frame](https://github.com/day8/re-frame) template as follows:
```in new re-frame facade +re-com +re-pressed +calva + 10x```

### Reframe docs & reference:
...
* [`src/cljs/facade/`](src/cljs/facade/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/facade/core.cljs): contains the SPA entry point, `init`
...
The `debug?` variable in [`config.cljs`](src/cljs/facade/config.cljs) defaults to `true` in
...
```clj
(ns facade.example
  (:require [facade.config :as config])
